        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-8 mb-8">
          ...
          <div className="mt-8 flex items-start gap-3">
            <Checkbox 
              ...
              className="mt-1 border-white/30 data-[state=checked]:bg-blue-600" 
            />
            <label htmlFor="agree" className="text-sm text-slate-300 leading-relaxed cursor-pointer select-none">
              I certify that I am an authorized representative of my municipality and I agree to the 
              Terms of Service and Data Security Policy outlined above.
            </label>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-white/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <Button 
              ...
              className="bg-blue-600 hover:bg-blue-500 text-white px-10 h-12 text-md font-semibold transition-all hover:scale-105 active:scale-95 disabled:opacity-50 disabled:hover:scale-100"
            >
              {loading ? (
