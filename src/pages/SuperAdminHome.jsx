...
import { Building2, Plus, Users, FileText, CheckCircle, LogIn, Search, Settings } from 'lucide-react';
          ...
          {filtered.map(m => (
            <div key={m.id} className="flex items-center gap-4 px-5 py-4 hover:bg-muted/30">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button variant="ghost" size="sm" onClick={() => handleEnterMuni(m)} className="text-xs h-7 gap-1 text-primary hover:text-primary/80">
